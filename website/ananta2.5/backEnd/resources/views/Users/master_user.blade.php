                ...
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <a class="dropdown-item" href="{{ url('/show_data_rating', Auth::user()->user_profile->user_id) }}">รายการคะแนนเมนู</a>
                    ...
                    <!-- <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <a class="dropdown-item" href="{{ url('/show/igd_stock', Auth::user()->user_profile->user_id) }}">รายการวัตถุดิบของผู้ใช้</a>
                        </div>
                    </li> -->
                </ul>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                            ...
                            <a class="dropdown-item" href="{{ url('/setting/profile' ,Auth::user()->user_profile->user_id) }}">
                                <img src="{{ asset('/storage/images/icon/user.png') }}"> โปรไฟล์
                            </a>

                            <a class="dropdown-item" href="{{ url('/show/food_allergy') }}">
                                <img src="{{ asset('/storage/images/icon/food.png') }}"> ข้อมูลการแพ้อาหาร
                            </a>

                            <a class="dropdown-item" href="{{ url('/show/igd_stock') }}">
                                <img src="{{ asset('/storage/images/icon/ingredients.png') }}"> รายการวัตถุดิบของผู้ใช้
                            </a>
