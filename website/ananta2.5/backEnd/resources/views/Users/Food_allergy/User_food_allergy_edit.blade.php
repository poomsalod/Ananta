    ...
    <div class="col-md-12 colblock">
        <div class="row">
            <div class="col-md-9 col-sm-8 colhead1">
                <span class="haedline1">เลือกวัตถุดิบที่แพ้ใหม่</span>
            </div>
        </div>
            ...
            <div class="col-md-12">
                ...
                <article class="leaderboard">
                    <header>
                        ...
                        <h1 class="leaderboard__title"><span class="leaderboard__title--top">รายการวัตถุดิบ</span><span class="leaderboard__title--bottom">จำนวนวัตถุดิบ: {{$count}}</span></h1>
                    ...
                    <main class="leaderboardprofiles">
                        ...
                        <form action="{{ url('/show/food_allergy/edit') }}" method="post" role="form" enctype="multipart/form-data">
                            {{csrf_field()}}
                            <article class="leaderboardprofile">

                                <input type="hidden" name="igd_info_id" value="{{ $value->igd_info_id }}">
                                <input type="hidden" name="food_allergy" value="{{ $food_allergy->food_allergy_id }}">
