    ...
    <div class="col-md-12 colblock">
        <div class="row">
            <div class="col-md-9 col-sm-8 colhead1">
                <span class="haedline1">เพิ่มวัตถุดิบที่แพ้</span>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <form action="{{ url('/food_allergy/search/igd') }}" method="GET" role="form">
                ...
                <article class="leaderboard">
                    <header>
                        <h1 class="leaderboard__title">
                            <span class="leaderboard__title--top">รายการวัตถุดิบ</span>
                            <span class="leaderboard__title--bottom">จำนวนวัตถุดิบ: {{$count}}</span>
                        </h1>
                    </header>
                    <main class="leaderboardprofiles">
                        ...
                        <form action="/show/food_allergy/create" method="post">
                            {{csrf_field()}}
