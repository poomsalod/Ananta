...
class TestFutureScreen extends StatefulWidget {
  const TestFutureScreen({Key? key}) : super(key: key);

  @override
  _TestFutureScreenState createState() => _TestFutureScreenState();
}

class _TestFutureScreenState extends State<TestFutureScreen> {
  ...
  Future init() async {
    ...
    setState(() {
      ...
      orderFood = List.generate(10, (i) => lodeFood[i]);
    });
  }
